...
const walls = [
    // @ts-ignore
    Bodies.rectangle(0, window.innerHeight / 2, 10, window.innerHeight, { isStatic: true, render: { fillStyle: 'white' } }),
    // @ts-ignore
    Bodies.rectangle(window.innerWidth, window.innerHeight / 2, 10, window.innerHeight, { isStatic: true, render: { fillStyle: 'white' } }),
    // @ts-ignore
    Bodies.rectangle(window.innerWidth / 2, 0, window.innerWidth, 10, { isStatic: true, render: { fillStyle: 'white' } }),
    // @ts-ignore
    Bodies.rectangle(window.innerWidth / 2, window.innerHeight, window.innerWidth, 10, { isStatic: true, render: { fillStyle: 'white' } })
];
World.add(world, walls);

// vertical lines (bumps)
const lineWidth = 10;
const numLines = 15;
// @ts-ignore
